...
INSTALL_ROOT="${SIMPLEZIP_RAR_INSTALL_ROOT:-${HOME}/Library/Application Support/SimpleZip}"
...
echo "Creating universal ${TOOLS_DIR}/rar..."
/usr/bin/lipo -create \
...
echo
echo "Installed to user data, not the SimpleZip app bundle:"
echo "${TOOLS_DIR}/rar"
echo
echo "RARLAB rar is proprietary/shareware. Verify redistribution rights with RARLAB"
echo "before shipping it inside any public app package."
